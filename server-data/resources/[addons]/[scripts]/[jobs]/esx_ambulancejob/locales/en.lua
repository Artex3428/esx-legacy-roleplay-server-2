Locales['en'] = {
  ...
  ['confirm_yes'] = 'Yes',
    ...
    ['service_not'] = 'you have not entered service! You\'ll have to enter service first.',
  ...
  -- Death
  ['respawn_available_in'] = 'You are expected to be transported to the hospital in %s minutes %s seconds',
  ['respawn_bleedout_in'] = 'You will bleed out in %s minutes %s seconds\n',
  ['respawn_bleedout_prompt'] = 'Hold [E] to be transported to the hospital',
  ['respawn_bleedout_fine'] = 'Hold [E] to be transported to the hospital for $%s',
  ['respawn_bleedout_fine_msg'] = 'You paid $%s to be transported to the hospital.',
