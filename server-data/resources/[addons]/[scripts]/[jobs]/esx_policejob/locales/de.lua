Locales['de'] = {
  ...
  ['armory_bought'] = 'Du kaufst eine %s für %s€',
  ...
  ['vehicleshop_awaiting_model'] = 'Das Fahrzeug ist derzeit am Herunterladen & Laden warte bitte...',
  ['confirm_no'] = 'Nein',
  ['confirm_yes'] = 'Ja',
  ['view'] = 'Ansehen',
  ['buy_car'] = 'Kaufen',
  ...
  ['service_in_announce'] = 'Officer %s ist nun im Dienst!',
  ['service_out'] = 'Du bist nun Off-Duty',
  ['service_out_announce'] = 'Officer %s ist nun nicht mehr im Dienst!',
  -- Action Menu
  ['menu_title'] = 'Polizei',
  ...
  ['license_revoked'] = 'Deine Lizenz %s wurde entzogen!',
  ['licence_you_revoked'] = 'Du entziehst eine %s welche zu %s gehörte.',
  ...
  ['got_confiscated'] = '%sx %s wurden konfisziert von %s',
  ['you_confiscated_account'] = 'Du konfiszierst %s€ (%s) von %s',
  ['got_confiscated_account'] = '%s€ (%s) wurde konfisziert von ~y~%s',
  ['you_confiscated_weapon'] = 'Du konfiszierst %s von %s mit %s Munition',
  ['got_confiscated_weapon'] = 'Dein %s mit %s wurde konfisziert von %s',
  ...
  ['have_withdrawn'] = 'Du zahlst %sx %s aus',
  ['have_deposited'] = 'Du zahlst %sx %s ein',
  ['quantity'] = 'Anzahl',
