...
local isDead, isHandcuffed, hasAlreadyJoined, playerInService = false, false, false, false
local LastEntity, CurrentAction, CurrentActionMsg
PlacedObjects = {}
	...
	while true do
		...
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'police' then
			...
			elseif playerInService then
				exports['artex-3dtextui']:StartText3d("Cloakroom", true, {46}, "Press [~g~E~w~] to open cloakroom", Config.PoliceStations.LSPD.Cloakrooms.Pos, 3.0, 1.0, false, false, function(pressedKey)
					if pressedKey == 46 then
						OpenCloakroomMenu()
				...
				exports['artex-3dtextui']:StartText3d("Armory", true, {46}, "Press [~g~E~w~] to open armory", Config.PoliceStations.LSPD.Armories.Pos, 3.0, 1.0, false, false, function(pressedKey)
					if pressedKey == 46 then
						OpenArmoryMenu(Config.PoliceStations.LSPD)
						SetCursorLocation(0.85, 0.5)
					end
				end)
		
				exports['artex-3dtextui']:StartText3d("Police Garage", true, {46}, "Press [~g~E~w~] to open Police garage", Config.PoliceStations.LSPD.Vehicles[1].Spawner, 3.0, 1.0, false, false, function(pressedKey)
					if pressedKey == 46 then
				...
				exports['artex-3dtextui']:StartText3d("Helicopter Garage", true, {46}, "Press [~g~E~w~] to open helicopter garage", Config.PoliceStations.LSPD.Helicopters[1].Spawner, 3.0, 1.0, false, false, function(pressedKey)
					if pressedKey == 46 then
						OpenVehicleSpawnerMenu('helicopter', "LSPD", "Helicopters", 1)
						SetCursorLocation(0.85, 0.5)
					end
				end)

				exports['artex-3dtextui']:StartText3d("Boss Actions", true, {46}, "Press [~g~E~w~] to open boss actions", Config.PoliceStations.LSPD.BossActions.Pos, 3.0, 1.0, false, false, function(pressedKey)
					if pressedKey == 46 then
