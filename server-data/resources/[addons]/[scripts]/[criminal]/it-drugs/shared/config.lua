...
Config.Framework = 'es_extended' -- Choose your framework ('qb-core', 'es_extended', 'ND_Core' 'autodetect')
...
Config.Target = 'ox_target' -- false -- Target system ('qb-target', 'ox_target' or false to disable)
