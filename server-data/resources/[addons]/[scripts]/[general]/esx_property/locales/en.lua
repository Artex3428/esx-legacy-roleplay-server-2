Locales['en'] = {
	...
	["no"] = "No",
	["action"] = "You %s %s !",
	["bought_furni"] = "You Have Bought A %s !",
	["edited_furni"] = "You Have Edited %s !",
	["cannot_buy"] = "You Cannot Buy This!",
	["cannot_edit"] = "You Cannot Edit This!",
	["store_title"] = "Store - %s",
	["back"] = "Return",
	["edit_title"] = "Editing - %s",
	["move_title"] = "Move",
	["deleted_confirm"] = "Deleting %s!",
	["deleted_error"] = "Cannot Delete %s!",
	...
	["furni_command_permission"] = "You Cannot Access This Menu!",
	["furni_reset_success"] = "Furniture Reset!",
	["furni_cannot_afford"] = "You Cannot Afford Todo this!",
	["furni_reset_error"] = "You Cannot  Reset This Property!",
	["furni_management"] = "Manage Furniture",

	--------- Key Strings ---------------

	["you_granted"] = 'You Have Been Granted Keys To %s.',
	["already_has"] = "This Player Already Has Keys!",
	["do_not_own"] = 'You do not own this property.',
	["key_revoked"] = 'Your Key Access To %s. Has Been Revoked',
	["no_keys"] = "This Player Does Not Have Keys!",
	["nearby"] = "Nearby Players",
	["gave_key"] = "Giving Keys to %s!",
	["key_cannot_give"] = "You Cannot Give This Player A Key",
	["remove_title"] = "Remove Keys From Player",
	["key_revoke_success"] = "Revoking Keys From %s.",
	["key_revoke_error"] = "You Cannot Remove A Key From this Person",
	...
	["remove_keys"] = "Remove Keys",
		...
		["enter_office"] = "Entering Office.",
		["enter_office_error"] = "You Cannot Enter The Office!",
		["exit_office"] = "Exiting Office.",
		["exit_office_error"] = "You Cannot Exit The Office!",
	...
	------------Command Strings-----------------------
		...
		["name"] = "Name",
		["confirm"] = "Confirm",
		["name_edit_success"] = "You Have Set The Property Name To %s.",
		["name_edit_error"] = "You Cannot Set The Property Name To %s.",
		...
		["unlock_error"] = "You Cannot Unlock This Property",
		["lock_error"] = "You Cannot Lock This Property",
		["prep_raid"] = "Preparing Raid!",
		["raiding"] = "Raiding...",
		["cancel_raiding"] = "Cancelled Raid!",
		["cannot_raid"] = "You Cannot Raid This Property.",
		["storage_pos_textui"] = "Press ~b~[G]~s~ To Set Storage Position",
		["storage_pos_success"] = "Storage Position Set.",
		["storage_pos_error"] = "Cannot Set Storage Position.",
		["wardrobe_pos_textui"] = "Press ~b~[G]~s~ To Set Wardrobe Position",
		["wardrobe_pos_success"] = "Wardrobe Position Set.",
		["wardrobe_pos_error"] = "Cannot Set Wardrobe Position.",
		["please_finish"] = "Please Finish Setting %s Position",
		...
		["raid_notify_error"] = "You need %sx %s to be able to raid!",
		...
		["retriving_notify"] = "Retrieving %s ...",
		["cannot_access"] = "You Cannot Access This Garage!",
		["store_textui"] = "Press ~b~[E]~s~ to Store %s",
		["garage_not_enabled"] = 'Garage Not Enabled On This Property.',
		["cannot_access_property"] = 'You Cannot Access this property.',
