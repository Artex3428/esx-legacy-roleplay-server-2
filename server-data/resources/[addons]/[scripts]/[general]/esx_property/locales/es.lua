Locales['es'] = {
	...
	["no"] = "No",
	["action"] = "¡ Tu %s %s !",
	["bought_furni"] = "¡ Has comprado un %s !",
	["edited_furni"] = "¡ Has editado %s !",
	["cannot_buy"] = "¡No puedes comprar esto!",
	["cannot_edit"] = "¡Usted no puede editar esto!",
	["store_title"] = "Tienda - %s",
	["back"] = "Volver",
	["edit_title"] = "Edición - %s",
	["move_title"] = "Mover",
	["delete_confirm"] = "¡Borrado %s!",
	["delete_error"] = "No se puede borrar %s!",
	...
	["furni_reset_error"] = "No puede ¡Restablecer esta propiedad!",
	["furni_management"] = "Administrar muebles",

	--------- Key Strings ---------------

	["you_granted"] = 'Se le han otorgado llaves a %s.',
	["already_has"] = "¡Este jugador ya tiene llaves!",
	["do_not_own"] = 'Usted no es dueño de esta propiedad.',
	["key_revoked"] = 'Su llave de acceso a %s. ha sido revocada',
	...
	["key_revoke_success"] = "Revocación de llaves de %s.",
	["key_revoke_error"] = "No puede quitar las llave a esta persona",
	...
	["enter_office_error"] = "¡Usted no puede entrar en la oficina!",
	["exit_office"] = "Saliendo de la oficina.",
	["exit_office_error"] = "¡Usted no puede salir de la oficina!",
	...
	["knocking"] = "Alguien Está Llamando A La Puerta.",
	["name_edit"] = "Editar nombre de propiedad",
	["name"] = "Nombre",
	["confirm"] = "Confirmar",
	["name_edit_success"] = "Ha establecido el nombre de la propiedad a %s.",
	["name_edit_error"] = "No puede establecer el nombre de la propiedad a %s.",
	...
	["unlock_error"] = "No puede desbloquear esta propiedad",
	["lock_error"] = "No puede ~bloquear~a~ esta propiedad",
	["prep_raid"] = "¡Preparando Redada!",
	["raiding"] = "Asaltando...",
	["cancel_raiding"] = "¡Redada Cancelada!",
	["cannot_raid"] = "No puedes Asaltar esta propiedad.",
	["storage_pos_textui"] = "Presione ~b~[G]~s~ para establecer la posición del inventario",
	["storage_pos_success"] = "Posición del Inventario establecida.",
	["storage_pos_error"] = "No se puede establecer la posición de inventario.",
	["wardrobe_pos_textui"] = "Presione ~b~[G]~s~ para establecer la posición del Armario",
	["wardrobe_pos_success"] = "Posición del Armario establecida.",
	["wardrobe_pos_error"] = "No se puede establecer la posición de armario.",
	["please_finish"] = "Finalice la configuración de posición de %s",
	...
	["raid_notify_error"] = "Necesitas  %sx %s  para poder asaltar!",
	["raid_notify_success"] = "¡Su propiedad está siendo actualmente Asaltada!",
	...
	["cannot_access_property"] = 'No puede Acceder a esta propiedad.',
