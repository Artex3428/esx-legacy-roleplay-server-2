Locales['it'] = {
	...
	["no"] = "No",
	["action"] = "Tu %s %s !",
	["bought_furni"] = "Hai Comprato A %s !",
	["edited_furni"] = "Hai modificato %s !",
	["cannot_buy"] = "Non puoi comprare questo!",
	["cannot_edit"] = "Non puoi modificare questo!",
	["store_title"] = "Negozio - %s",
	["back"] = "Ritorno",
	["edit_title"] = "Modifica - %s",
	["move_title"] = "Sposta",
	["deleted_confirm"] = "Eliminazione di %s!",
	["deleted_error"] = "Impossibile eliminare %s!",
	...
	["furni_command_permission"] = "Impossibile accedere a questo menu!",
	["furni_reset_success"] = "Reimposta mobili!",
	["furni_cannot_afford"] = "Non puoi permetterti di farlo!",
	["furni_reset_error"] = "Impossibile reimpostare questa proprietà!",
	["furni_management"] = "Gestisci mobili",

	--------- Key Strings ---------------

	["you_granted"] = 'Ti sono state concesse le chiavi per %s.',
	["already_has"] = "Questo giocatore ha già le chiavi!",
	["do_not_own"] = 'non possiedi questa proprietà.',
	["key_revoked"] = 'La tua chiave di accesso a %s. È stato Revocato',
	...
	["key_revoke_success"] = "Revoca chiavi da %s.",
	["key_revoke_error"] = "Non puoi rimuovere una chiave da questa persona",
	...
	["enter_office"] = "Entrando in Ufficio.",
	["enter_office_error"] = "Non puoi entrare in ufficio!",
	["exit_office"] = "Esco dall\'ufficio.",
	["exit_office_error"] = "Non puoi uscire dall\'ufficio!",
	...
	["knocking"] = "Qualcuno sta bussando alla porta.",
	["name_edit"] = "Modifica nome proprietà",
	["name"] = "Nome",
	["confirm"] = "Conferma",
	["name_edit_success"] = "Hai impostato il nome della proprietà su %s.",
	["name_edit_error"] = "Non puoi impostare il nome della proprietà su %s.",
	...
	["unlock_error"] = "Non puoi sbloccare questa proprietà",
	["lock_error"] = "Non puoi Bloccare questa proprietà",
	["prep_raid"] = "Preparazione Raid!",
	["raiding"] = "Raiding...",
	["cancel_raiding"] = "Raid annullato!",
	["cannot_raid"] = "Non puoi razziare questa proprietà.",
	["storage_pos_textui"] = "Premi ~b~[G]~s~ per impostare la posizione di archiviazione",
	["storage_pos_success"] = "Storage Posizione impostata.",
	["storage_pos_error"] = "Impossibile impostare la posizione Memoria.",
	["wardrobe_pos_textui"] = "Premi ~b~[G]~s~ per impostare la posizione dell\'armadio",
	["wardrobe_pos_success"] = "Wardrobe Posizione impostata.",
	["wardrobe_pos_error"] = "Impossibile impostare la posizione dell\'armadio.",
	["please_finish"] = "Completa l\'impostazione della %s posizione",
	...
	["raid_notify_error"] = "Hai bisogno di %sx %s per poter invadere la casa!",
	...
	["cannot_access_property"] = 'Impossibile accedere a questa proprietà.',
