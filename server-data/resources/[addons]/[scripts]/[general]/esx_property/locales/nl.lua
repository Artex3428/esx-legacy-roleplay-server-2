Locales['nl'] = {
	...
	["no"] = "Nee",
	["action"] = "Jij %s %s !",
	["bought_furni"] = "Je hebt een %s  gekocht!",
	["edited_furni"] = "Je hebt %s  aangepast!",
	["cannot_buy"] = "Je kan dit niet kopen!",
	["cannot_edit"] = "Je kan dit niet aanpassen!",
	["store_title"] = "Winkel - %s",
	["back"] = "Ga terug",
	["edit_title"] = "Aanpassen - %s",
	["move_title"] = "Verplaats",
	["deleted_confirm"] = "Verwijderen van %s!",
	["deleted_error"] = "Kan %s niet verwijderen!",
	...
	["furni_command_permission"] = "Je kan dit menu niet betreden!",
	["furni_reset_success"] = "Meubel Reset!",
	["furni_cannot_afford"] = "Je kan dit niet betalen!",
	["furni_reset_error"] = "Je kent dit eigendom niet resetten !",
	["furni_management"] = "Beheer meubels",

	--------- Key Strings ---------------

	["you_granted"] = 'Je hebt de sleutels van %s gekregen.',
	["already_has"] = "Deze speler heeft al sleutels!",
	["do_not_own"] = 'Dit is niet jouw eigendom.',
	["key_revoked"] = 'Je sleutel van %s. is afgenomen',
	["no_keys"] = "Deze speler heeft geen sleutels!",
	["nearby"] = "Spelers Dichtbij",
	["gave_key"] = "Je hebt een sleutel gegeven aan %s!",
	["key_cannot_give"] = "Je kan deze speler geen sleutel geven.",
	["remove_title"] = "Neem sleutels van speler",
	["key_revoke_success"] = "Sleutels afgenomen van%s.",
	["key_revoke_error"] = "Je kan de sleutels van deze speler niet afnemen",
	...
	["remove_keys"] = "Verwijder sleutels",
		...
		["enter_office"] = "Betreedt  het kantoor .",
		["enter_office_error"] = "Je kan dit kantoor niet betreden!",
		["exit_office"] = "Verlaat het kantoor.",
		["exit_office_error"] = "Je kan dit kantoor niet verlaten!",
	...
	------------Command Strings-----------------------
		...
		["knocking"]  = "Iemand klopt op de deur.",
		["name_edit"] = "Verander eigendom naam",
		["name"] = "Naam",
		["confirm"] = "Bevestig",
		["name_edit_success"] = "Je hebt de naam van dit eigendom veranderd naar %s.",
		["name_edit_error"] = "Je kan dit eigendom niet deze naam geven %s.",
		...
		["prep_raid"] = "Deur forceren voorbereiden!",
		["raiding"] = "Deur forceren...",
		["cancel_raiding"] = "Deur forceren geannuleerd!",
		["cannot_raid"] = "Je kunt dit eigendom niet binnenvallen.",
		["storage_pos_textui"] = "Klik op ~b~[G]~s~ om de inventaris te plaatsen",
		["storage_pos_success"] = "Inventaris positie veranderd.",
		["storage_pos_error"] = "De positie van de inventaris kan niet worden verplaatst.",
		["wardrobe_pos_textui"] = "Klik op ~b~[G]~s~ om de kledingkast te plaatsen",
		["wardrobe_pos_success"] = "Kledingkast positie veranderd.",
		["wardrobe_pos_error"] = "De kledingkast positie kan niet veranderd worden.",
		["please_finish"] = "Maak het plaatsen van %s eerst af.",
		...
		["raid_notify_error"] = "Je hebt  %sx %s nodig om de deur te forceren!",
		...
		["cannot_access_property"] = 'Je kan  dit eigendom  niet betreden.',
