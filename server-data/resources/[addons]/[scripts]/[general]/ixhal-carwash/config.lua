Config = {
    ...
    Framework = 'esxlegacy',--Supports 'qbcore' and 'esxlegacy'-- You can also use this with any other framework, Just check out the framework.lua file and edit it to your needs.
    ...
    cash_account_name = 'money',--Name of your cash account (ESX would be 'money')
