$(window).ready(function () {
  ...
  function getVehicles(locale, vehicle, amount = null) {
    ...
    for (let i = 0; i < vehicleData.length; i++) {
      ...
      html += "<div><span style='color: rgb(179, 179, 179);'>Model: </span><strong>" + vehicleData[i].model + "</strong></div>";
      html += "<div><span style='color: rgb(179, 179, 179);'>Plate: </span><strong>" + vehicleData[i].plate + "</strong></div>";
      html +=
        "<div><span style='color: rgb(179, 179, 179);'>Condition: </span><strong>" + vehicleDamagePercent + "</strong></div>";
      html +=
