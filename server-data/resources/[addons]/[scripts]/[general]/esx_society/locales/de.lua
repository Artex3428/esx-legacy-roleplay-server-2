Locales['de'] = {
  ...
  ['fire']                   = 'Feuern',
  ['grade']                  = 'Grad',
  ['have_deposited']         = 'Du zahlst ein %s€',
  ['have_withdrawn']         = 'Du zahlst aus %s€',
  ...
  ['yes']                    = 'Ja',
  ['you_have']               = 'Du hast %s€ wartent in deiner Geld Waschmaschine (24h).',
  ['you_have_laundered']     = 'Du hast dein Geld gewaschen Anzahl: %s€',
