...
function OnDoorEnter(data, seatIndex)
    print(json.encode(data)) -- Debug: Print the entire data object
    local ped = PlayerPedId()

    -- Check if the data contains a valid vehicle entity
    local vehicle = data.entity or data.vehicle -- Adjust according to the data structure

    if DoesEntityExist(vehicle) then
        TaskEnterVehicle(ped, vehicle, 10000, seatIndex, 1.5, 1, 0)
        print("Attempting to enter seat", seatIndex, "of vehicle", vehicle)
    else
        print("Vehicle does not exist or seat is occupied!")
    end
end
...
api.addGlobalVehicle({
    {
        ...
        label = locale('enter_front_driver_door'),
    ...
    },
    {
        ...
        icon = 'fa-solid fa-car-side',
        label = locale('enter_front_passanger_door'),
    ...
    },
    {
        ...
        icon = 'fa-solid fa-car-side',
        label = locale('enter_rear_driver_door'),
    ...
    },
    {
        ...
        icon = 'fa-solid fa-car-side',
        label = locale('enter_rear_passanger_door'),
