...
function ESX.ShowNotification(message, notifyType, length)
    return IsResourceFound('ox_lib') and exports['ox_lib']:notify({description = message, type = notifyType,duration = length,})
end
...
---@param account string Account name (money/bank)
---@return table|nil
